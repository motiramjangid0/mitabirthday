...
let playing=true;function toggleMusic(){let a=document.getElementById('music');playing?a.pause():a.play().catch(()=>{});playing=!playing;document.getElementById('musicBtn').textContent=playing?'❚❚':'♫'}
